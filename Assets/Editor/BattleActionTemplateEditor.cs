...
namespace Editor
{
    [CustomEditor(typeof(BattleActionTemplate))]
    public class BattleActionTemplateEditor : UnityEditor.Editor
    {
        private const string QTESequenceFolderName = "QTESequence";
        
        private BattleActionTemplate _template;
        ...
        {
            _template = (BattleActionTemplate) target;
            Object sequenceObject = serializedObject.FindProperty(BattleActionTemplate.QTESequencePropertyName).objectReferenceValue;
        ...
        private void DrawQTESequence()
        {
            SerializedProperty qteSequenceProperty =
                serializedObject.FindProperty(BattleActionTemplate.QTESequencePropertyName);
        ...
        {
            SerializedProperty sequenceProperty = serializedObject.FindProperty(BattleActionTemplate.QTESequencePropertyName);
