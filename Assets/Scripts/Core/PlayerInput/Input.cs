...
namespace Core.PlayerInput
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""Direction_Gamepad"",
                    ""id"": ""cf30a84b-2d13-4004-ab30-666fb4e66c38"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""3a04d1b6-0fa4-4589-b27f-2c7c56ae0693"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""94b6082f-bcc3-4e9b-96f1-eda56e444c28"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""6abdc665-3afd-4b0e-b720-14eec2319f7d"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""9a0532ba-b2b7-45a4-adb0-804d2f054673"",
    ...
    ""controlSchemes"": [
        ...
        ~@Input()
        {
            UnityEngine.Debug.Assert(!m_Explore.enabled, "This will cause a leak and performance issues, Input.Explore.Disable() has not been called.");
            ...
            UnityEngine.Debug.Assert(!m_Dialogue.enabled, "This will cause a leak and performance issues, Input.Dialogue.Disable() has not been called.");
